...
INSERT INTO account (ver, username, password, status) VALUES (0, 'guest', 'guest', 0);
...
INSERT INTO t_user (id, ver, tenent_code, account_username, permission_bit1, permission_bit2, permission_bit3, status) VALUES (2, 0, 'org1', 'test', 0, 0, 0, 0);
INSERT INTO t_user (id, ver, tenent_code, account_username, permission_bit1, permission_bit2, permission_bit3, status) VALUES (2, 0, 'org1', 'guest', 0, 0, 0, 2);